...
#ifndef PM_LORA_APP_ID
#define PM_LORA_APP_ID  ( PM_MODULE_MAX_ID - 1 )
#endif
#endif
...
/**
  * @brief  lorawan_ed_app_process
  * @param  rt_uint32_t ev
  * @retval None
  */
static void lorawan_ed_app_process(rt_uint32_t ev)
{
