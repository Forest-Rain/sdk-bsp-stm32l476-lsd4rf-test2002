 ...
 *
 * \brief     Region implementation for CN470S
 *
 *           Self-define by user
 *           #define CN470S_FREQ_UP_DN_EQU  Downlink Frequence = Uplink Frequence
 *           #define CN470S_FREQ_UP_DN_DIF  Donwlink Frequence != Uplink Frequence
 *
...
#ifdef REGION_CN470S_FREQ_UP_DN_DIF
#define LOG_TAG             "LoRaWAN.PHY.CN470S.DIF"
#define CN470S_FIRST_TX_CHANNEL         CN470S_FREQ_UP_DN_DIF_FIRST_TX_CHANNEL
#define CN470S_FIRST_RX1_CHANNEL        CN470S_FREQ_UP_DN_DIF_FIRST_RX1_CHANNEL
#define CN470S_LAST_RX1_CHANNEL         CN470S_FREQ_UP_DN_DIF_LAST_RX1_CHANNEL
#define CN470S_CHNNELS_MASK0_DEFAULT    0x00FF
#define CN470S_RX_WND_2_FREQ            CN470S_FREQ_UP_DN_DIF_RX_WND_2_FREQ
#else
#define LOG_TAG             "LoRaWAN.PHY.CN470S.EQU"
#define CN470S_FIRST_TX_CHANNEL         CN470S_FREQ_UP_DN_EQU_FIRST_RX1_CHANNEL
#define CN470S_FIRST_RX1_CHANNEL        CN470S_FREQ_UP_DN_EQU_FIRST_RX1_CHANNEL
#define CN470S_LAST_RX1_CHANNEL         CN470S_FREQ_UP_DN_EQU_LAST_RX1_CHANNEL
#define CN470S_CHNNELS_MASK0_DEFAULT    0x00FF
#define CN470S_RX_WND_2_FREQ            CN470S_FREQ_UP_DN_EQU_RX_WND_2_FREQ
#endif
/*!
...
void RegionCN470SInitDefaults( InitDefaultsParams_t* params )
{
    ...
    switch( params->Type )
    {
        case INIT_TYPE_INIT:
        {
            ...
            {
                NvmCtx.Channels[i].Frequency = CN470S_FIRST_TX_CHANNEL + i * 200000;
                NvmCtx.Channels[i].DrRange.Value = ( DR_5 << 4 ) | DR_0;
                NvmCtx.Channels[i].Band = 0;
                
                LORAWAN_ED_DEBUG_LOG(LORAWAN_ED_STACK_DEBUG_PHY_REGION, DBG_LVL,  " Channnel[%02d]: %d,%02X",i,NvmCtx.Channels[i].Frequency,NvmCtx.Channels[i].DrRange.Value);
            }

            // Initialize the channels default mask
            NvmCtx.ChannelsDefaultMask[0] = CN470S_CHNNELS_MASK0_DEFAULT;

            LORAWAN_ED_DEBUG_LOG(LORAWAN_ED_STACK_DEBUG_PHY_REGION, DBG_LVL, "Default Channels Mask: %04X\r\n", NvmCtx.ChannelsDefaultMask[0]);
...
bool RegionCN470SRxConfig( RxConfigParams_t* rxConfig, int8_t* datarate )
{
    ...
    if( rxConfig->RxSlot == RX_SLOT_WIN_1 )
    {
        ...
        // +Get the frequency only for debug info
