...
#define CHIP_NAME_STM32L476VGTX
...
/** After configuring corresponding KEY, you can use it.
 *
 * KEY Pin define
 *
 */

#define BSP_KEY1_PIN       GET_PIN(B, 15)
#define BSP_KEY2_PIN       GET_PIN(D, 8)
#define BSP_KEY3_PIN       GET_PIN(D, 9)

/*-------------------------- KEY CONFIG END --------------------------*/

/*-------------------------- BEEP CONFIG BEGIN --------------------------*/

/** After configuring corresponding BEEP, you can use it.
 *
 * BEEP Pin define
 *
 */

#define BSP_BEEP_PIN       GET_PIN(D, 10)
